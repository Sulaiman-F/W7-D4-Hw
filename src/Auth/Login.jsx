...
function Login() {
  const API = "https://68372a55664e72d28e43d073.mockapi.io/User";
    ...
    <>
      {error && (
        <Alert
          severity="error"
          onClose={() => setError("")}
          className="absolute top-5 left-1/2 transform -translate-x-1/2 w-72 md:w-96"
        >
          {error}
        </Alert>
      )}
          ...
          <div className="flex flex-col items-center bg-neutral-150 p-5 gap-5 md:px-10 rounded-lg shadow-md">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p>
                ...
                <Link
                  className="hover:underline cursor-pointer hover:text-sky-500"
                  to="/register"
                >
                  Register
                </Link>
